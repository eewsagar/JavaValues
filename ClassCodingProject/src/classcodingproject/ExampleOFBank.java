...
//transactio function defination starts here
    public static void transaction() throws Exception {
        try {
            ...
            System.out.println("Enter transaction type : (deposit / Withdrawal)");                      //prints the double quoted text on output console screen
            ...
            String sqlbal = "SELECT balance1 FROM `tbl_transaction` WHERE accno1 ='" + accno2 + "' "
                    ...
                    + "`tbl_transaction` WHERE accno1 ='" + accno2 + "')"; // subquery -- query inside query
            ...
            if (trantype.equals("deposit")) {
                balance1 = balance1 + amount; // deposit
...
//                String sql2 = "INSERT INTO `tbl_transaction` VALUES('" + accno2 + "','" + date + "','" + trantype + "','" + amount + "','" + balance1 + "')";
                ...
                if (balance1 > amount) {
                    balance1 = balance1 - amount; //withdrawal
                    stmt1 = connection.createStatement();
                    System.out.println("Inserting records into the table...");
    ...
    public static void printData() throws SQLException {
        try {
            ...
            String sql5 = "select a.accno,a.name,a.age,a.address,t.date1,"
                    ...
                    + "tbl_transaction t where a.accno=t.accno1 and t.accno1='"+accnumber+"'"; // join query
            System.out.println("sql5 : " + sql5);
            try {
                String name = ""; // file name
                PrintWriter outputfile = null;

                StringBuffer sbf1 = new StringBuffer(); // transaction
                sbf1.append("\n*******************\n"
                        + "Date \t\t" + "Amount\t"
                ...
                while (rs.next()) {
                    ...
                    StringBuffer sbf = new StringBuffer();// new referncce value in memory
...
//deleteAccount() function defination starts here
    public static void deleteAccount() {
        try {
            ...
            String filename = name + ".txt"; // logic to give the name to file name
